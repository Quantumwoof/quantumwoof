      ...
      questions: [
        {
          ...
          choices: [
            { id: "a", text: "Earth spins us into its own shadow" },
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "They hide behind the Moon" },
    ...
    woofCheck: {
      ...
      questions: [
        ...
        },
        {
          ...
          prompt: "Why do stars twinkle?",
          choices: [
            { id: "a", text: "Wiggly air bends their thin light" },
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "Earth putting on a winter coat" },
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "Both, if you squint really hard" },
            { id: "b", text: "Solar" },
            { id: "c", text: "Lunar" },
          ],
        },
    ...
    woofCheck: {
      ...
      questions: [
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "toward the nearest dog treats" },
      ...
      questions: [
        {
          ...
          choices: [
            { id: "a", text: "Hosky barks loud enough to light it" },
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "they drink too much cosmic juice" },
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "only some of the heaviest stars" },
      ...
      questions: [
        {
          ...
          choices: [
            { id: "a", text: "shorter waves than red" },
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "where Hosky hid the treats" },
    ...
    woofCheck: {
      ...
      questions: [
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "is glued to the pale river with cosmic tape" },
    ...
    woofCheck: {
      ...
      questions: [
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "they are embarrassed and blushing" },
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "someone reheating leftovers in space" },
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "13.8 billion years old" },
    ...
    woofCheck: {
      ...
      questions: [
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "how many stickers you put on it" },
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "we see different amounts of the Moon’s sunlit half" },
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "the sky printers run a new poster each month" },
      ...
      questions: [
        {
          ...
          choices: [
            { id: "a", text: "falling toward Earth and missing" },
        ...
        },
        {
          ...
          choices: [
            { id: "a", text: "the station is filled with helium balloons" },
